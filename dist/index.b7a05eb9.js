...
console.log((0, _loadshDefault.default).camelCase(str));
console.log((0, _loadshDefault.default).snakeCase(str));
console.log((0, _loadshDefault.default).kebabCase(str));
